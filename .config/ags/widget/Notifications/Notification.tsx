...
export const Notification = (n: AstalNotifd.Notification) => (
  <box vertical cssClasses={["notification"]} setup={() => timeout(TIMEOUT_DELAY, () => n.dismiss())}>
    <box cssClasses={["header"]}>
      {(n.appIcon || n.desktopEntry) && <image cssClasses={["app-icon"]} iconName={n.appIcon || n.desktopEntry} />}
      <label
        cssClasses={["app-name"]}
        halign={START}
      ...
      />
      <label cssClasses={["time"]} hexpand halign={END} label={time(n.time)?.toString()} />
    ...
    <box cssClasses={["content"]}>
      <box vertical>
        ...
        {n.image && n.get_hint("internal") && (
          <image file={n.image} heightRequest={100} widthRequest={100} cssClasses={["image"]} />
        )}
        {n.body && (
          <label
            cssClasses={["body"]}
