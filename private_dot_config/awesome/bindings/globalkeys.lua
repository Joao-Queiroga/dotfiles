...
function _M.get()
	local globalkeys = gears.table.join(
		...
		awful.key({ modkey,           }, "w", function () RC.menu:show() end,
		...
		awful.key({ "Control", "Shift"   }, "Escape", function () awful.spawn(terminal .. " -e htop") end,
					{description = "open htop", group = "launcher"}),
		awful.key({ modkey, "Shift"	  }, "Return", function () awful.spawn(file_manager) end,
					{description = "open a file_manager", group = "launcher"}),
